...
public class PesquisaPagamentosHOJE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PAGAMENTOS A RECEBER HOJE :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaPagamentosHOJE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaPagamentosHOJE().setVisible(true);
            }
        });
    }
    ...
    // End of variables declaration//GEN-END:variables
        ...
        public void buscarPagamentosHoje(){
        //Classe para buscar os pagamentos
        CRUD_Pagamentos crud  = new CRUD_Pagamentos();
        ArrayList<Pagamentos> pags = crud.buscarPagamentosHoje(tbpesquisa.getText());
    ...
    private void preenchePagamentos() {
        //Método para preencher os dados do pagamento quando um for selecionado
        CRUD_Pagamentos crud = new CRUD_Pagamentos();
        //
        ...
        //Como o  uruário selecionou um pagamento vamos setar para ser possivel paga-la
        //desabilitar  os campos de edição e habilitar o botão Editar para ser possivel editar quando nele for clicado
