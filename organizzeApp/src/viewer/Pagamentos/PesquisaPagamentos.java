...
public class PesquisaPagamentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TODOS OS PAGAMENTOS :");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(170, 80, 210, 20);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaPagamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaPagamentos().setVisible(true);
            }
        });
    }
    ...
    public void buscarPagamentos(){
        ...
        ArrayList<Pagamentos> pags = crud.buscarTodosPagamentos(tbpesquisa.getText());
    ...
    private void preenchePagamentos() {
        //Método para preencher nos campos os dados de um pagamento quando um for selecionado
        CRUD_Pagamentos crud = new CRUD_Pagamentos();
        //
