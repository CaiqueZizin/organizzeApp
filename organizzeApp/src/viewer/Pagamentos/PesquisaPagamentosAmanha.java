...
public class PesquisaPagamentosAmanha extends javax.swing.JFrame {
     ...
     */
    public PesquisaPagamentosAmanha() {
        initComponents();
        buscarPagamentosAmanha();     
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PAGAMENTOS A RECEBER AMANHÃ : ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaPagamentosAmanha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaPagamentosAmanha().setVisible(true);
            }
        });
    }
    ...
    // End of variables declaration//GEN-END:variables
        ...
        public void buscarPagamentosAmanha(){
        //Classe para buscar os pagamentos
        CRUD_Pagamentos crud  = new CRUD_Pagamentos();
        ArrayList<Pagamentos> pags = crud.buscarPagamentosAmanha(tbpesquisa.getText());
    ...
    private void preenchePagamentos() {
        //Método para preencher os dados de um pagamento quando um for selecionado
        CRUD_Pagamentos crud = new CRUD_Pagamentos();
        //
