...
public class PesquisaContasAmanha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CONTAS A PAGAR AMANHÃ :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaContasAmanha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaContasAmanha().setVisible(true);
            }
        });
    }
    ...
    // End of variables declaration//GEN-END:variables
        ...
        public void buscarContasAmanha(){
        //Classe para buscar as contas
        CRUD_Contas crud  = new CRUD_Contas();
        ArrayList<Contas> contas = crud.buscarContasAmanha(tbpesquisa.getText());
    ...
    private void limparTabela(){
        //metodo para sempre limpar as linhas antigas da tabela
    ...
    private void preencheContas() {
        //Método para preencher nos campos da tela os dados da conta selecionada
        CRUD_Contas crud = new CRUD_Contas();
        //
