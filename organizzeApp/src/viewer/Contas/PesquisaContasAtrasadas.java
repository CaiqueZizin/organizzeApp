 ...
 * @author Caique
 */
public class PesquisaContasAtrasadas extends javax.swing.JFrame {
     ...
     * 
     */
    public PesquisaContasAtrasadas() {
        initComponents();
        buscarContasAtrasadas();     
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CONTAS ATRASADAS A PAGAR :");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(200, 74, 210, 30);
    ...
    private void tabelaMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseReleased
        try {
            ...
            Logger.getLogger(PesquisaContasAtrasadas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaContasAtrasadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaContasAtrasadas().setVisible(true);
            }
        });
    }
    ...
    // End of variables declaration//GEN-END:variables
        ...
        public void buscarContasAtrasadas(){
        //Classe para buscar as contas
        CRUD_Contas crud  = new CRUD_Contas();
        ArrayList<Contas> contas = crud.buscarContasAtrasadas(tbpesquisa.getText());
    ...
    private void limparTabela(){
        ...
        //Para quando ele pesquisar ele atualizar a tabela automaticamente
    ...
    private void preencheContas() throws ParseException {
        //Método para preencher nos campos os dados da conta quando a mesma for selecionada
        CRUD_Contas crud = new CRUD_Contas();
        //
        String id = dados.getValueAt(tabela.getSelectedRow() , 0).toString();
        //
        Contas contas = crud.buscarPorChave(id);
        //Agora aqui iremos pegar os dados que foram lançados para a classe de entidade  e jogar  
        //para nossa tela
        SimpleDateFormat formato = new SimpleDateFormat("dd-MM-yyyy");
